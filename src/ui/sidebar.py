...
def create_sidebar(config_manager: ConfigManager) -> Dict[str, Any]:
            ...
            if models:
                ...
                with col1:
                    temperature = st.slider(
                        ...
                        min_value=0.0,
                        max_value=2.0,
                        value=float(default_params['temperature']),
                        step=0.1,
                    ...
                    top_p = st.slider(
                        ...
                        min_value=0.0,
                        max_value=1.0,
                        value=float(default_params['top_p']),
                        step=0.05,
                        help="Nucleus sampling (controls diversity)"
                    )
                    ...
                    top_k = st.number_input(
                        ...
                        min_value=1,
                        max_value=100,
                        value=int(default_params['top_k']),
                        step=1,
                        help="Top-k sampling (limits token choices)"
                    )
                ...
                with col2:
                    num_ctx = st.number_input(
                        ...
                        min_value=512,
                        max_value=200000,
                        value=int(default_params['num_ctx']),
                        step=1024,
                        help="Maximum input tokens (context size)"
                    )
                    ...
                    num_predict = st.number_input(
                        ...
                        min_value=128,
                        max_value=200000,
                        value=int(default_params['num_predict']),
                        step=512,
  ...
  "address": "string"
        ...
        config_summary = {
            ...
            "llm_parameters": llm_parameters if mode in ["LLM-based", "OCR + LLM Extraction"] and 'llm_parameters' in locals() else None
        }
